                    ...
                    <div class="entry">
                                ...
                                <a href="work-details.php">
                                    <div class="work-item">
                                        ...
                                        <div class="work-title">
											...
											<p class="text-white">Web, eCommerce, Magento</p>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="work-details.php">
                                    <div class="work-item">
                                        ...
                                        <div class="work-title ">
											...
											<p class="text-white">UI Design</p>
                                        </div>
                                    </div>
                                </a>
                                </div>
                        ...
                        <div class="row">
                            <div class="col col_1_2">
                                <div class="inner">
                                    <a href="#" class="btn button_styled_medium btn_gray alignright"><span>⇐</span> Newer </a>
                                </div>
                            </div>
                            
                            <div class="col col_1_2">
                                <div class="inner">
                                    <a href="#" class="btn button_styled_medium btn_gray alignleft"> Older <span>⇒</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
