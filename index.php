                    ...
                    <div class="header-title box_white">
						...
						<form action="#" method="POST" >
							<div class="header-search">
								<input type="text" name="s" class="s"  autocomplete="on"/>
							</div>
						</form>
                        </div>
                        <!--/top search-->
                    ...
                    <div class="row">
                        ...
                        <div class="inner">
                            <div class="widget_categories">
                                <ul>
                                  <!--  <li><a href="#">All</a></li>--->
                                    <li><a href="site-web.php">Web</a></li>
                                    <li><a href="application.php">Mobile</a></li>
                                    <li><a href="application.php">App</a></li>
                                    <li><a href="graphisme.php">Logo</a></li>
                                </ul>
                            </div>
                        </div>
                        </div>
                        ...
                        <ul id="work-carousel">
                           <li>
                                        <a href="site-web.php">
                                            ...
                                            <p class="text-white">Création & Design</p>
                                            </div>
                                            </div>
                                         </a>
                                ...
                                <li>
                                        ...
                                        <a href="referencement.php">
                                            ...
                                            <p class="text-white">Hébergement & Référencement </p>
                                            </div>
                                            </div>
                                        </a>
        ...
        <div class="clear"></div>
                    ...
                    <div class="container">
                        <div class="slider-inner">
                            <h2 class="text-bold">Technologies utilisés</h2>
