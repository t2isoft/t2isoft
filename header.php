...
<link rel="shortcut icon" href="http://www.t2isoft.com/dist/img/favicon.ico">
<link rel="apple-touch-icon" href="dist/img/apple-touch-icon-57x57-iphone.php">
<link rel="apple-touch-icon" sizes="72x72" href="dist/img/apple-touch-icon-72x72-ipad.php">
<link rel="apple-touch-icon" sizes="114x114" href="dist/img/apple-touch-icon-114x114-iphone4.php">
<!-- Mobile optimized -->
        ...
        <div class="white-background">
            <div class="container">
                <div class="header">
                    ...
                    <!--logo-->
                       <div class="logo"><a href="index.php"><img src="dist/img/logo.png" alt="T2Isoft" margin-top: 2cm;  /></a></div>
                    <!--/logo-->
                    <!--Top Menu-->
                       <div id="topmenu">
                        <ul class="dropdown">
