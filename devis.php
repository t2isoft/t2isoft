                        ...
                        <li class="price_col col col_1_5">
                            <div class="price_item">
                                ...
                                <div class="price_col_body">
                                    <ul>
                                        <li class="box_light_gray">Création du site</li>
                                        <li>Panel d'administration</li>
                                        <li class="box_light_gray">Installation sur hébergement web</li>
                                        <li>Création hébergement web & nom de domaine</li>
                                        <li class="box_light_gray">Optimisations du référencement naturel</li>
                                        <li>Option e-commerce</li>
                                    </ul>
                                </div>
                            </div>
                        </li>
